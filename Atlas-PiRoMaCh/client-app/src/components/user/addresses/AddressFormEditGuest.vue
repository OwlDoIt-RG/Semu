...
<template>
    ...
    <div v-if="!addressStore.isLoading" class="address-form">
        ...
        <fieldset>
            ...
            <input id="email" v-model="addressStore.email" type="email" name="email" required />
        </fieldset>
        ...
        <button @click="addressStore.validateInvoiceAddress()">Valider</button>
